...
# 512M parameter model with Full Parameter + Optimizer + Gradient Partitioning
...
ZERO_STAGE=3      # ZeRO Stage 3: Full Parameter Sharding

# Paths
BASE_PATH=$workdir/gpt
DATA_PATH=$BASE_PATH/my-gpt2_text_document
DS_CONFIG=$workdir/ds_config_large_zero3.json
...
# Create DeepSpeed config for ZeRO Stage 3
cat <<EOT > $DS_CONFIG
{
...
echo "DeepSpeed config created (ZeRO Stage 3)"
...
echo "========================================================================"
echo "LARGE Model ZeRO Stage 3 Training (512M parameters)"
echo "========================================================================"
echo "Configuration:"
echo "  Model: GPT-2 Large (${NLAYERS} layers, ${HIDDEN} hidden)"
echo "  Parameters: ~512M"
echo "  ZeRO Stage: ${ZERO_STAGE} (Full Parameter + Optimizer + Gradient Partitioning)"
...
echo "  Memory savings: ~N_gpu times (linear scaling with N_gpu)"
echo "========================================================================"
