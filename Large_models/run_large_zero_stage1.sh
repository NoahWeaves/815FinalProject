...
# Large Model with ZeRO Stage 1
# 512M parameter model with Optimizer State Partitioning
...
DS_CONFIG=$workdir/ds_config_large_zero1.json
...
echo "========================================================================"
echo "LARGE Model ZeRO Stage 1 Training (512M parameters)"
echo "========================================================================"
echo "Configuration:"
