...
# Megatron-DeepSpeed with ZeRO Stage 1
...
DS_CONFIG=$workdir/ds_config_zero1.json
...
# Create DeepSpeed config for ZeRO Stage 1
cat <<EOT > $DS_CONFIG
{
...
echo "DeepSpeed config created (ZeRO Stage 1)"
...
echo "="*80
echo "Megatron-DeepSpeed ZeRO Stage 1 Training"
echo "="*80
echo "Configuration:"
echo "  Model: GPT-2 (${NLAYERS} layers, ${HIDDEN} hidden)"
echo "  ZeRO Stage: ${ZERO_STAGE} (Optimizer State Partitioning)"
...
echo "  Memory savings: ~4x for optimizer states"
echo "="*80
